...
//this is to check if nakalogin yung accout or hindi
...
body {
    background: #e96443;
    background: linear-gradient(to right, #000080, #800080, #e96443);
    min-height: 150vh;
    overflow-x: hidden
}</style>
                                </head>
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="bg-light p-4 d-flex justify-content-end text-center">
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <h5 class="font-weight-bold mb-0 d-block">30,150</h5><small class="text-muted"> <i class="fas fa-image mr-1"></i>Photos</small>
                    </li>
                    <li class="list-inline-item">
                        <h5 class="font-weight-bold mb-0 d-block">900,999</h5><small class="text-muted"> <i class="fas fa-user mr-1"></i>Followers</small>
                    </li>
                    <li class="list-inline-item">
                        <h5 class="font-weight-bold mb-0 d-block">560</h5><small class="text-muted"> <i class="fas fa-user mr-1"></i>Following</small>
                    </li>
                </ul>
            </div>
            ...
            <div class="px-4 py-3">
                ...
                <div class="p-4 rounded shadow-sm bg-light">
                    <p class="font-italic mb-0">A Seeker</p>
                    <p class="font-italic mb-0">Motto: Memento Vivere</p>
